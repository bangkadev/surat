        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Surat Keluar Internal</li>
                </ol>
            </nav>
            @if (session('success'))
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="card-title fw-bold mb-0"><i class="ti ti-mail me-2"></i>Surat Keluar Internal</h5>
                        <div class="d-flex">
                    ...
                    <div class="table-responsive">
                        <table id="skiTable" class="table table-striped table-hover table-sm">
                            ...
                            <tbody>
                                @foreach ($suratKeluarInternal as $surat)
                                    <tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('ski.destroy', $surat->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white" id="tambahSuratModalLabel"><i class="ti ti-plus me-2"></i>Tambah
                        Surat Keluar Internal</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="{{ route('ski.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title text-white" id="editSuratModalLabel{{ $surat->id }}"><i
                                class="ti ti-edit me-2"></i>Edit Surat Keluar Internal</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="{{ route('ski.update', $surat->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row g-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportExcel').on('click', function() {
                ...
                $('#skiTable tbody tr').each(function() {
                    data.push([
                ...
                XLSX.utils.book_append_sheet(wb, ws, "Surat Keluar Internal");
                XLSX.writeFile(wb, 'surat-keluar-internal.xlsx');
            });
            ...
            $('#exportPDF').on('click', function() {
                ...
                doc.autoTable({
                    ...
                    didDrawPage: function(data) {
                        doc.setFontSize(16);
                        doc.text("Daftar Surat Keluar Internal", 105, 15, {
                            align: 'center'
                        });
                        doc.setFontSize(8);
                ...
                doc.save('surat-keluar-internal.pdf');
            });
        });
    </script>
@endpush
