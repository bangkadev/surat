        ...
        <div class="col-md-12">
            <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Surat Masuk Internal</li>
                </ol>
            </nav>
            @if (session('success'))
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h5 class="card-title fw-bold mb-0"><i class="ti ti-mail me-2"></i>Surat Masuk Internal</h5>
                        <div class="d-flex">
                    ...
                    <div class="table-responsive">
                        <table id="smiTable" class="table table-striped table-hover table-sm">
                            ...
                            <tbody>
                                @foreach ($suratMasukInternal as $surat)
                                    <tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('smi.destroy', $surat->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title text-white" id="tambahSuratModalLabel"><i class="ti ti-plus me-2"></i>Tambah
                        Surat Masuk Internal</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="{{ route('smi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row g-3">
                            <div class="col-md-6">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-info text-white">
                        <h5 class="modal-title text-white" id="editSuratModalLabel{{ $surat->id }}"><i
                                class="ti ti-edit me-2"></i>Edit Surat Masuk Internal</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="{{ route('smi.update', $surat->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row g-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#exportExcel').on('click', function() {
                ...
                $('#smiTable tbody tr').each(function() {
                    data.push([
                ...
                XLSX.utils.book_append_sheet(wb, ws, "Surat Masuk Internal");
                XLSX.writeFile(wb, 'surat-masuk-internal.xlsx');
            });
            ...
            $('#exportPDF').on('click', function() {
                ...
                doc.autoTable({
                    ...
                    didDrawPage: function(data) {
                        doc.setFontSize(16);
                        doc.text("Daftar Surat Masuk Internal", 105, 15, {
                            align: 'center'
                        });
                        doc.setFontSize(8);
                ...
                doc.save('surat-masuk-internal.pdf');
            });
        });
    </script>
@endpush
